...
#define MSR_PVM_GPT2SPT_BASE		0x4b564df7
...
#define PVM_HC_ALLOC_PTE		(PVM_HC_SPECIAL_BASE+16)
#define PVM_HC_RELEASE_PTE		(PVM_HC_SPECIAL_BASE+17)
#define PVM_HC_SET_PAGE_OFFSET	(PVM_HC_SPECIAL_BASE+18)
#define PVM_HC_MARK_KPFN (PVM_HC_SPECIAL_BASE+19)
#define PVM_HC_FREE_KPFN (PVM_HC_SPECIAL_BASE+20)
#define PVM_HC_INIT_DIRECT_MAPPING_SHADOW (PVM_HC_SPECIAL_BASE+21)
#define PVM_HC_PRIO_IRQ     (PVM_HC_SPECIAL_BASE+22)
...
#define RUNPV_SET_PTE_OP_WRITE	(1 << 5)
#define RUNPV_SET_PTE_OP_XCHG	(2 << 5)
#define RUNPV_SET_PTE_OP_TRY_CMP_XCHG	(4 << 5)
#define RUNPV_SET_PTE_OP_MASK	(RUNPV_SET_PTE_OP_WRITE | RUNPV_SET_PTE_OP_XCHG | RUNPV_SET_PTE_OP_TRY_CMP_XCHG)
...
#define RUNPV_HC_BIND_HOST_PAGE		(RUNPV_HC_SPECIAL_BASE+0)
#define RUNPV_HC_UNBIND_HOST_PAGE	(RUNPV_HC_SPECIAL_BASE+1)
#define RUNPV_HC_MARK_PAGE_PT		(RUNPV_HC_SPECIAL_BASE+2)
#define RUNPV_HC_TLB_FLUSH			(RUNPV_HC_SPECIAL_BASE+3)
#define RUNPV_HC_TLB_FLUSH_CURRENT	(RUNPV_HC_SPECIAL_BASE+4)
#define RUNPV_HC_TLB_INVLPG		(RUNPV_HC_SPECIAL_BASE+5)

#define RUNPV_HC_MMU_PTE_SET			(RUNPV_HC_SPECIAL_BASE+6)
#define RUNPV_HC_MMU_PMD_SET			(RUNPV_HC_MMU_PTE_SET+1)
#define RUNPV_HC_MMU_PUD_SET			(RUNPV_HC_MMU_PTE_SET+2)
#define RUNPV_HC_MMU_P4D_SET			(RUNPV_HC_MMU_PTE_SET+3)

#define RUNPV_HC_MMU_PTEP_GET			(RUNPV_HC_MMU_PTE_SET+4)
#define RUNPV_HC_MMU_PMDP_GET			(RUNPV_HC_MMU_PTEP_GET+1)

#define RUNPV_HC_MMU_PTEP_GET_AND_CLEAR	(RUNPV_HC_MMU_PTEP_GET+4)
#define RUNPV_HC_MMU_PMDP_GET_AND_CLEAR	(RUNPV_HC_MMU_PTEP_GET_AND_CLEAR+1)
#define RUNPV_HC_MMU_PUDP_GET_AND_CLEAR	(RUNPV_HC_MMU_PTEP_GET_AND_CLEAR+2)
#define RUNPV_HC_MMU_PTEP_GET_AND_CLEAR_FULL \
					(RUNPV_HC_MMU_PTEP_GET_AND_CLEAR+3)
#define RUNPV_HC_MMU_PTEP_SET_WRPROTECT \
					(RUNPV_HC_MMU_PTEP_GET_AND_CLEAR_FULL+1)
#define RUNPV_HC_MMU_PTEP_SET_ACCESS_FLAGS \
					(RUNPV_HC_MMU_PTEP_SET_WRPROTECT+1)
#define RUNPV_HC_MMU_PTEP_TEST_AND_CLEAR_YOUNG \
					(RUNPV_HC_MMU_PTEP_SET_ACCESS_FLAGS+1)
#define RUNPV_HC_MMU_PMDP_HUGE_GET_AND_CLEAR \
					(RUNPV_HC_MMU_PTEP_TEST_AND_CLEAR_YOUNG+1)
#define RUNPV_HC_MMU_PUDP_HUGE_GET_AND_CLEAR \
					(RUNPV_HC_MMU_PMDP_HUGE_GET_AND_CLEAR+1)
#define RUNPV_HC_MMU_PMDP_SET_WRPROTECT \
					(RUNPV_HC_MMU_PUDP_HUGE_GET_AND_CLEAR+1)
#define RUNPV_HC_MMU_PMDP_ESTABLISH	(RUNPV_HC_MMU_PMDP_SET_WRPROTECT+1)
#define RUNPV_HC_MMU_PMDP_SET_ACCESS_FLAGS \
					(RUNPV_HC_MMU_PMDP_ESTABLISH+1)
#define RUNPV_HC_MMU_PUDP_SET_ACCESS_FLAGS \
					(RUNPV_HC_MMU_PMDP_SET_ACCESS_FLAGS+1)
#define RUNPV_HC_MMU_PMDP_TEST_AND_CLEAR_YOUNG \
					(RUNPV_HC_MMU_PUDP_SET_ACCESS_FLAGS+1)
#define RUNPV_HC_MMU_PUDP_TEST_AND_CLEAR_YOUNG \
